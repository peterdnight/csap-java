...
@WebServlet(name = "HelloServlet", urlPatterns = { "/showHelloServlet" })
public class HelloServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		System.out.println( new Date() + "\tDemo only - standard out should never be used, configure logging framework + upload");
